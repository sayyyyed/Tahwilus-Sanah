 ...
 * @author Sayyed
 */
public class itungUmur extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/muslimpro/hitungUmurPic.jpg"))); // NOI18N
...
//        String jawi = "Jawi";
        ...
        hitungUmur cari = new hitungUmur(tanggal, bulan,tahun);
       
//        falaks tahwil = new tahwilulJawi (tanggal,bulan,tahun,jawi);
//        tahwil.tahwil();
        cari.tahwil();  
        String tanggal2 = Integer.toString(cari.getUmurHari());
        String bulan2 = Integer.toString(cari.getUmurBulan());
        String tahun2 = Integer.toString(cari.getUmurTahun());
        jLabel3.setText(tahun2+" tahun, "+bulan2+ " bulan, "+  tanggal2 + " hari");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(itungUmur.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
